...
#. [1] D. P. Bovet and M. Cesati, *Understanding the Linux Kernel*, 1st ed.
   Sebastopol, CA, USA: O'Reilly Media, 2000.
   ISBN: 978-0-596-00002-5.

#. [2] D. P. Bovet and M. Cesati, *Understanding the Linux Kernel*, 2nd ed.
   Sebastopol, CA, USA: O'Reilly Media, 2002.
   ISBN: 978-0-596-00213-5.

#. [3] D. P. Bovet and M. Cesati, *Understanding the Linux Kernel*, 3rd ed.
   Sebastopol, CA, USA: O'Reilly Media, 2005.
   ISBN: 978-0-596-00565-5.
...
#. [4] A. Rubini and J. Corbet, *Linux Device Drivers*, 1st ed.
   Sebastopol, CA, USA: O'Reilly Media, 1998.

#. [5] A. Rubini and J. Corbet, *Linux Device Drivers*, 2nd ed.
   Sebastopol, CA, USA: O'Reilly Media, 2001.

#. [6] J. Corbet, A. Rubini, and G. Kroah-Hartman, *Linux Device Drivers*,
   3rd ed. Sebastopol, CA, USA: O'Reilly Media, 2005.
   ISBN: 978-0-596-00590-7.
...
Kernel İnternals ve Genel Mimari
----------------------------------

#. [7] R. Love, *Linux Kernel Development*, 3rd ed.
   Upper Saddle River, NJ, USA: Addison-Wesley, 2010.
   ISBN: 978-0-672-32946-3.

#. [8] M. Gorman, *Understanding the Linux Virtual Memory Manager*.
   Upper Saddle River, NJ, USA: Prentice Hall, 2004.
   ISBN: 978-0-131-45348-5.
   Çevrimiçi (ücretsiz): https://www.kernel.org/doc/gorman/

#. [9] W. Mauerer, *Professional Linux Kernel Architecture*.
   Indianapolis, IN, USA: Wrox Press, 2008.
   ISBN: 978-0-470-34343-2.

#. [10] G. Kroah-Hartman, *Linux Kernel in a Nutshell*.
...
#. [11] K. N. Billimoria, *Linux Kernel Programming: A Comprehensive Guide to Kernel Internals, Writing Kernel Modules, and Kernel Synchronization*, 1st ed.
    Birmingham, UK: Packt Publishing, 2021.

#. [12] K. N. Billimoria, *Linux Kernel Programming Part 2: Writing Character Device Drivers: Learn to Work with User-Kernel Interfaces, Handle Peripheral I/O and Hardware Interrupts*, 1st ed.
    Birmingham, UK: Packt Publishing, 2021.
...
#. [13] K. N. Billimoria, *Linux Kernel Debugging: Leverage Proven Tools and Advanced Techniques to Effectively Debug Linux Kernels and Kernel Modules*, 1st ed.
...
#. [14] M. Kerrisk, *The Linux Programming Interface*.
    San Francisco, CA, USA: No Starch Press, 2010.
    ISBN: 978-1-593-27220-3.

#. [15] W. R. Stevens and S. A. Rago, *Advanced Programming in the UNIX Environment*, 3rd ed.
    Upper Saddle River, NJ, USA: Addison-Wesley, 2013.
    ISBN: 978-0-321-63773-4.

#. [16] B. Ward, *How Linux Works: What Every Superuser Should Know*, 
    3rd ed.
    San Francisco, CA, USA: No Starch Press, 2021.

#. [17] J. Levine, *Linkers and Loaders*.
...
#. [18] The Linux Kernel Organization, "The Linux Kernel Documentation,"
    [Çevrimiçi]. Erişim: https://www.kernel.org/doc/html/latest/
    [Erişim tarihi: Mayıs 2026].

#. [19] M. Gorman, "Understanding the Linux Virtual Memory Manager,"
    [Çevrimiçi]. Erişim: https://www.kernel.org/doc/gorman/
    [Erişim tarihi: Mayıs 2026].

#. [20] LWN.net, "Kernel development news and articles," [Çevrimiçi].
    Erişim: https://lwn.net
    [Erişim tarihi: Mayıs 2026].

#. [21] LWN.net, "Kernel Index — Memory Management," [Çevrimiçi].
    Erişim: https://lwn.net/Kernel/Index/#Memory_management
    [Erişim tarihi: Mayıs 2026].

#. [22] Bootlin, "Elixir Cross Referencer — Linux Kernel Source,"
    [Çevrimiçi]. Erişim: https://elixir.bootlin.com/linux/latest/source
    [Erişim tarihi: Mayıs 2026].

#. [23] KernelNewbies, "Linux Kernel Newbies," [Çevrimiçi].
    Erişim: https://kernelnewbies.org
    [Erişim tarihi: Mayıs 2026].
