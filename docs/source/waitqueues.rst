...
thread'i kopararak (*preemption* ile) kesmemesini sağlamaktadır. Uyandırılan thread'ler eğer yüksek bir önceliğe
sahipse hemen kopararak (preemption'a yol açarak) CPU'ya atanabilmektedir. Bu makro bunu engellemektedir. Makro
şöyle yazılmıştır:
