...
altıncı bölümlerde kavramsal olarak değinmiştik. Bu bölümde bu alt alt sistemi ayrıntılarıyla 
ele alacağız.
...
Tarihsel süreci aşağıdaki tabloyla da özetlemek istiyoruz:

.. figure:: _static/writeback-history-table.png
   :alt: Geri yazım mekanizmalarının tarihsel gelişimi
   :align: center
   :width: 70%

Biz çalışma kuyruklarını ayrı bir bölümde ayrıntılarıyla ele alacağız. Ancak bu bölümde geri yazım
konusunun daha iyi anlaşılmasını sağlamak için çalışma kuyrukları hakkında temel bazı bilgileri de
vermek istiyoruz.
